...
field table -- deliberately *not* from
`struct ocp_smart_extended_log`. A table copied out of the header could
only ever confirm that nvme-cli agrees with itself; an independently
transcribed one can disagree, which is the whole point.
