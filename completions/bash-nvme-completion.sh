...
plugin_utils_opts () {
	...
	_nvme_detect_value_completion
	case "$1" in
		"version"|"help"|"dump-command-metadata")
			;;
		*)
		opts+=""
		if [[ $completing_value -eq 1 ]]; then
