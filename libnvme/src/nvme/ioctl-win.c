		...
		struct libnvme_passthru_cmd *cmd)
{
	...
	pass_through->Cdb[6] = 0;    /* Parameter list length (MSB) */
	pass_through->Cdb[7] = 0;    /* Parameter list length */
	pass_through->Cdb[8] = 0;    /* Parameter list length (LSB) */
	pass_through->Cdb[9] = 0;    /* Control */
